...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('binder_programtype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal('binder', ['ProgramType'])

        # Adding field 'Program.program_type'
        db.add_column('binder_program', 'program_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['binder.ProgramType'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ProgramType'
        db.delete_table('binder_programtype')

        # Deleting field 'Program.program_type'
        db.delete_column('binder_program', 'program_type_id')
