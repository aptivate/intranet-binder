...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IntranetGroup.inactive'
        db.add_column('binder_intranetgroup', 'inactive',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'IntranetGroup.inactive'
        db.delete_column('binder_intranetgroup', 'inactive')
    ...
    models = {
        ...
        'binder.intranetuser': {
            ...
            'date_joined_nondjango': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
