...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IntranetUser.date_joined_nondjango'
        db.add_column('binder_intranetuser', 'date_joined_nondjango',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'IntranetUser.date_joined_nondjango'
        db.delete_column('binder_intranetuser', 'date_joined_nondjango')
