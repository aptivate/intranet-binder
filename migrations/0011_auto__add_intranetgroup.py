...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IntranetGroup'
        db.create_table('binder_intranetgroup', (
            ('group_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.Group'], unique=True, primary_key=True)),
            ('administrators', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('binder', ['IntranetGroup'])

    def backwards(self, orm):
        # Deleting model 'IntranetGroup'
        db.delete_table('binder_intranetgroup')
    ...
    models = {
        ...
        'binder.intranetgroup': {
            'Meta': {'object_name': 'IntranetGroup', '_ormbases': ['auth.Group']},
            'administrators': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
